...
import {
  ...
  IonSelect, IonSelectOption, IonToggle, IonToast, IonRange
} from '@ionic/react';
import {
...
const ProgramacionCursoPag: React.FC = () => {
  ...
  const [courseData] = useState({
    ...
    totalLessons: 15,
    completedLessons: 5,
    currentLesson: 'Variables y Tipos de Datos'
  });
  ...
  const [lessonsData] = useState<LessonContent[]>([
    {
      ...
      type: 'text',
      content: 'El lenguaje C es un lenguaje de programación de propósito general desarrollado por Dennis Ritchie en 1972. C99 es el estándar ISO/IEC 9899:1999, que introdujo importantes mejoras como variables de longitud variable, comentarios de línea (//) y nuevos tipos de datos. Este lenguaje es fundamental para entender la programación a bajo nivel y la gestión de memoria.',
      completed: true,
      images: [
        'https://disenowebakus.net/imagenes/articulos/fundamentos-programacion.jpg',
        'https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Código_en_lenguaje_C.png/330px-Código_en_lenguaje_C.png'
      ],
      videoSrc: '/src/video/ProgLeccion1.mp4',
      audioSrc: '/src/audio/ProgAudio1.mp3'
    },
    {
      id: '2',
      title: 'Estructura de un Programa en C',
      type: 'text',
      content: 'Todo programa en C tiene una estructura básica que incluye directivas de preprocesador (#include), la función main() y las declaraciones de variables. La función main() es el punto de entrada del programa. Un programa típico comienza con #include <stdio.h> para incluir funciones de entrada y salida estándar.',
      completed: true,
      images: [
        'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhBBsaTqF18sMii28Z-F5JLI_lN2QgTgsbNkJSKHE2JR5txibCWjwIMKCKzQHxF_Sfn9MhbR3uHisJ8mbZVnU3Z0Jww5dpXBLaZsr3MdKsSaqeiWhihez4gB8kDPCQ3BK2ThFGf6dhlpxA/s320/segundoC.JPG',
        'https://i.ytimg.com/vi/FsTeMqqVmaA/hqdefault.jpg'
      ],
      videoSrc: '/src/video/ProgLeccion2.mp4',
      audioSrc: '/src/audio/ProgAudio2.mp3'
    },
    {
      id: '3',
      title: 'Variables y Tipos de Datos',
      type: 'text',
      content: 'En C99, las variables deben declararse antes de usarse y tienen tipos específicos. Los tipos básicos incluyen: int (enteros), float (números decimales), double (precisión doble), char (caracteres) y _Bool (booleanos introducidos en C99). Cada tipo tiene un tamaño específico en memoria y un rango de valores válidos. Las variables deben inicializarse antes de su uso para evitar comportamientos indefinidos.',
      completed: false,
      images: [
        'https://i.ytimg.com/vi/FsTeMqqVmaA/hqdefault.jpg',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaDm8smxedEyoaKZ0XmeG9rT_AGtZZY7NKyw&s'
      ],
      videoSrc: '/src/video/ProgLeccion3.mp4',
      audioSrc: '/src/audio/ProgAudio3.mp3'
    },
    {
      id: '4',
      title: 'Operadores en C',
      type: 'text',
      content: 'C proporciona varios tipos de operadores: aritméticos (+, -, *, /, %), relacionales (<, >, ==, !=), lógicos (&&, ||, !), de asignación (=, +=, -=) y de incremento/decremento (++, --). La precedencia de operadores determina el orden de evaluación en expresiones complejas.',
      completed: false,
      images: [
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwTcU9WTPGAFcPdng2W8o7HvxZ3_9zxHPM4A&s',
        'https://lh5.googleusercontent.com/proxy/RylEK1i48p_vvEJ0r0BUCo3nyL-G0kAHKmartd4pA04IvhRhXhfYf0ExkIRX1HfpOWD3ZCh0QerGYwodAJpEGxRsuTLYDPXWA1i_vBSTLJwhQg'
      ],
      videoSrc: '/src/video/ProgLeccion4.mp4',
      audioSrc: '/src/audio/ProgAudio4.mp3'
    },
    {
      id: '5',
      title: 'Estructuras de Control: Condicionales',
      type: 'text',
      content: 'Las estructuras condicionales permiten ejecutar código basado en condiciones. C ofrece if, if-else, if-else if y switch. La declaración if evalúa una expresión booleana y ejecuta un bloque de código si es verdadera. switch es útil para múltiples comparaciones con una variable.',
      completed: false,
      images: [
        'https://i0.wp.com/pediaa.com/wp-content/uploads/2018/08/Difference-Between-if-else-and-switch-Comparison-Summary.jpg?resize=475%2C538',
        'https://dcodingames.com/wp-content/uploads/2016/11/tituloEstructuraIfElse.fw_.png'
      ],
      videoSrc: '/src/video/ProgLeccion5.mp4',
            ...
            {lesson.images && lesson.images.map((imageUrl, index) => (
              <div key={index} style={{
                ...
                >
                  <img 
                    src={imageUrl}
                    alt={`Representación Visual ${index + 1} de ${lesson.title}`}
                    style={{
                      width: '100%',
                      height: '150px',
                      objectFit: 'cover',
  ...
  export default ProgramacionCursoPag;